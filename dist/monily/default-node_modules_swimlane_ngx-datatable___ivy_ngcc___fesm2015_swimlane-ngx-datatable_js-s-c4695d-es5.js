(function () {
  ...
  (self["webpackChunkmonily"] = self["webpackChunkmonily"] || []).push([["default-node_modules_swimlane_ngx-datatable___ivy_ngcc___fesm2015_swimlane-ngx-datatable_js-s-c4695d"], {
    /***/38550:
    /*!**********************************************************************************************!*\
        ...
        function _HelperService(httpService, localService) {
          ...
          this.getMonthlyExpenses = function (expenses) {
            ...
            Object.keys(monthlyExpensesPaid).map(function (month) {
              chartData.push({
                ...
                label: _this27.monthNames[month],
                spacing: 2,
                labelWidth: 30
              });
              chartData.push({
          ...
          this.uploadImage = function (event, remarks) {
            ...
            if (file) {
              ...
              formData.append('user_id', _this27.authToken.userId);
              formData.append("file", file);
              _this27.httpService.uploadImage('uploadFile', formData).subscribe(function (res) {
                console.log('====================================');
                console.log(res);
                console.log('====================================');
              }), function (err) {
...
//# sourceMappingURL=default-node_modules_swimlane_ngx-datatable___ivy_ngcc___fesm2015_swimlane-ngx-datatable_js-s-c4695d-es5.js.map